...
gameRoutes.post("/:chatId/tossEnded", async (req, res) => {
  ...
  try {
    ...
    if (winner == "player1") {
      ...
      //Update game balance
      gameCreator.gameBalance += game.wagerAmount * 2;
      player2.gameBalance -= game.wagerAmount;
      ...
      //Update game balance
      gameCreator.gameBalance -= game.wagerAmount;
      player2.gameBalance += game.wagerAmount * 2;
